...
#SBATCH -J unsupervised # job name
#SBATCH --gpus=1
#SBATCH -q gpu
#SBATCH -o unsupervised.out
#SBATCH -e unsupervised.err
...
torchrun --nproc_per_node 1 \
    ...
    --train_data ./example_unsupervised_data_split \
